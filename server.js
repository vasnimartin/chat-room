...
app.post('/signup', (req, res) =>{
    connection.query("INSERT INTO `chat`.`chat_users`(`user_name`,`user_id`,`user_password`,`user_full_name`,`user_image`) VALUES ('"+req.body.username+"','"+req.body.username+"','"+req.body.username+"','"+req.body.username+"','default.jpg')", function (error, results, fields) {
        if (error) throw error;
